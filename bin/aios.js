...
Options:
  ...
  --no-chiefs    Skip installation of Chief domain agents (Claude Code only)
  --no-skills    Skip installation of Skills workflows (Claude Code only)
  -h, --help     Show this help message
  ...
  switch (command) {
    ...
    case 'install': {
      ...
      const installOptions = {
        ...
        noChiefs: installArgs.includes('--no-chiefs'),
        noSkills: installArgs.includes('--no-skills'),
      };
