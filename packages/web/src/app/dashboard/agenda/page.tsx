...
export default async function AgendaPage({
  ...
  // Fetch brokers for filter dropdown
          ...
          <tbody className="divide-y divide-gray-200">
            {appointments && appointments.length > 0 ? (
              appointments.map((apt) => {
                ...
                const brokerRaw = apt.broker as unknown
                const broker = Array.isArray(brokerRaw) ? brokerRaw[0] as { id: string; name: string } | undefined : brokerRaw as { id: string; name: string } | null
