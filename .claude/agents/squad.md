...
When I need specialists, I invoke them as subagents via Task tool:
...
| @pedro-valerio | Process validation, workflow audit |
| @sop-extractor | Extract SOPs from content |
