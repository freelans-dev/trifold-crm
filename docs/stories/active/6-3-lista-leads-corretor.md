...
## Acceptance Criteria
- [ ] AC1: Pagina `/broker/leads` lista leads designados ao corretor logado
- [ ] AC2: Tabela com colunas: nome, empreendimento, etapa (badge com cor), score, ultimo contato, data de entrada
- [ ] AC3: Ordenacao por colunas (clicar no header ordena)
- [ ] AC4: Busca por nome ou telefone
- [ ] AC5: Filtro por empreendimento (se corretor atende mais de 1)
- [ ] AC6: Filtro por etapa do pipeline
- [ ] AC7: Clicar em lead navega para `/broker/leads/[id]`
- [ ] AC8: Badge de "novo" para leads designados nas ultimas 24h
- [ ] AC9: Contagem total: "X leads designados"
- [ ] AC10: Empty state se nao ha leads
